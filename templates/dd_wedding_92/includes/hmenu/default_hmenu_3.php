...
ob_start();
?>
<li class=" bd-menuitem-25 {submenu_icon_only}">
<?php 
$menuStartItem = ob_get_clean();
ob_start();
?>

<ul class=" bd-menu-15 nav nav-center nav-pills<?php echo $class_sfx;?>" <?php echo $tag_id; ?>>
<?php
$bHMenu = ob_get_clean();
$eHMenu = "</ul>";
?>
...
<?php $subMenuStartItem = ob_get_clean(); ?>
    ...
    if ($item->deeper) {
        ...
        ?>
        <div class="bd-menu-16-popup"><ul class=" bd-menu-16">
        <?php
    }
