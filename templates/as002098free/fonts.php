...
function fontChooser($fontfamily)
{
	...
	switch($fontfamily)
	{
		...
		case 'Muli':
			...
			break;
		case 'Luckiest Guy':
			$font_arr['fontlink'] = "<link href='https://fonts.googleapis.com/css?family=Luckiest+Guy' rel='stylesheet' type='text/css'>";
			$font_arr['fontfamily'] = "font-family: 'Luckiest Guy', Arial, serif !important;";
			break;
		case 'Lato':
